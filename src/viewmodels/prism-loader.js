...
var components = require('./prism-components');
...
module.exports = {
    ...
    loadFileSource: function (name) {
        return this.fileSourceCache[name] = this.fileSourceCache[name] || fs.readFileSync(path.join(__dirname, "../public/bower_components/prism/components/prism-" + name + ".js"), "utf8");
    },
